 ...
 * <br>=
 * ========================= <br>
 * Asynchronous implementation of language level for. ForTask run all parameters
 * specified by mIterator in sequence in an asynchronous loop, if the worker
 * break on any parameter, the whole loop task finished. <br>=
 * =========================
 */
